...
firebase_admin.initialize_app(cred,{
    ...
    'storageBucket':"faceattendancerealtime-10de2.appspot.com"
})
...
while True:
    ...
    imgModeList[0] = cv2.resize(imgModeList[modeType], (414,633))
    ...
    for encodeFace,faceLoc in zip(encodeCurrentFrame,faceCurrentFrame):
        ...
        if matches[matchIndex]:
            #print("Know Face detected",studentIds[matchIndex])
            y1,x2,y2,x1 =faceLoc
